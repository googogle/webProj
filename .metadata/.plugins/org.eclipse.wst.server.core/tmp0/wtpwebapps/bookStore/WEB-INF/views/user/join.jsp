...
<body>
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" method="POST" id="frm">
					<div class="row">
					...
					<div class="mb-3">
						<label for="email">비밀번호</label> <input type="text"
							class="form-control" id="password" placeholder="" required>
						<div class="invalid-feedback">비밀번호를 입력해주세요.</div>
					</div>

					<div class="mb-3" style="display: none">
						<input type="text" class="form-control" name="hashedPW" required>
					...
					<button class="btn btn-primary btn-lg btn-block"
						onclick="doEncryption()" type="button">가입 완료</button>
				</form>
			</div>
		</div>
  ...
  function doEncryption() {
	    ...
	    var nameDOM = document.getElementsByName('name');
	 	var inputText = document.getElementById('password').value;
	 	var frm = document.getElementById('frm');

	    var hash = CryptoJS.SHA256(inputText).toString(); 
	    hashedPW[0].value = hash;
	    console.log(hashedPW[0].value);
